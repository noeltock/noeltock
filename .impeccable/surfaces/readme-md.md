...
**Audience:** WordPress and AI practitioners, employees, open-source collaborators, and potential enterprise customers arriving at Noel's GitHub profile.

**Job:** Understand Noel's current work quickly, see how the projects relate, and open the most relevant repository, package, or field note.

**Proof:** Real project names, source-grounded descriptions, repository links, and recent shipped work. No vanity statistics or invented activity.

**Constraints:** Ship as GitHub-valid Markdown and repository-owned image assets. Preserve light/dark readability, narrow-width access, meaningful alt text, and local-only review before any push.
